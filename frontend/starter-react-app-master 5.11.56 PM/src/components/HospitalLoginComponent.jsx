...
const HospitalLoginComponent=()=>{
    ...
    const handleSubmit=(e)=> {
      ...
      .then((res) => {
          ...
          localStorage.setItem("hospitalName",res.data);
          navigate("/hospital/apptlist");
      ...
      return (
<div id="formdiv">
<form id="hospitalRegistrationform" class="row row-cols-lg-12 g-3 align-items-center" style={{width:"40%",marginTop: "100px",backgroundColor:"black",borderRadius:"20px 0px 20px 0px", boxShadow:"8px 12px 10px 5px grey",padding:"8px"}}
