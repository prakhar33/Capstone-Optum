...
const AdminManageDoctor = (props) => {
    ...
    useEffect(() => {
        ...
        axios.get('http://127.0.0.1:9090/admin/getalldoctors', {
      })
      .then((res) => {
                ...
                <tbody>
                    {
                        patientAppts?.map(
                            ...
                            <tr key={patientAppt}>
                                ...
                                <td >{patientAppt.hospitalName}</td>
                                ...
                                <td><button className='deleteButton' onClick={()=>{handleDeleteAppt(patientAppt.name)}}  title='Delete Doctor'><span class="fa fa-trash"></span></button></td>
                            </tr>
                        )
                    }
                </tbody>
