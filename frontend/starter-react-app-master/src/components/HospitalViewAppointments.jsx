...
const HospitalViewAppointments = (props) => {
    ...
    useEffect(() => {
        ...
        HospitalService.getHospitalappointmentsbyHid(localStorage.getItem('Hid'))
        .then((res) => {
                ...
                <tbody>
                    {
                        patientAppts?.map(
                            ...
                            <tr key={patientAppt[0]}>
                                ...
                                <td>{patientAppt[3]}</td>
                                <td>{patientAppt[4]}</td>
                                <td>{ SlotToTime(patientAppt[5]).start}</td>
                                <td>{ SlotToTime(patientAppt[5]).end}</td>
                                <td >{patientAppt[7]}</td>
...
export default HospitalViewAppointments;