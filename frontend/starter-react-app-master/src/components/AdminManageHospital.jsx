...
const AdminManageHospital = (props) => {
    ...
    const handleDeleteAppt = (hospital_id) => {
        swal({
            title: "Are you sure?",
    ...
    useEffect(() => {
        ...
        axios.get('http://127.0.0.1:9090/admin/getAllHospitals', {
      })
      .then((res) => {
...
{localStorage.getItem("Adminlogin")==='1' ?
        <div>
            ...
            {setSlots && showSlots()}
            <center style={{marginTop:"10px"}}><h2>Manage Hospitals</h2></center>
                ...
                <tbody>
                    {
                        patientAppts?.map(
                            ...
                            <tr key={patientAppt}>
                                ...
                                <td><button className='deleteButton' onClick={()=>{handleDeleteAppt(patientAppt.hospital_id)}} title='Delete'><span class="fa fa-trash"></span></button></td>
                            </tr>
                        )
                    }
                </tbody>
